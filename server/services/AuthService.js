...
class AuthService {
    ...
    static verifyToken(req, res, next) {
        var _a, _b;
        try {
            const token = ((_a = req === null || req === void 0 ? void 0 : req.cookies) === null || _a === void 0 ? void 0 : _a.token) || ((_b = req.headers['authorization']) === null || _b === void 0 ? void 0 : _b.split('Bearer ')[1]);
            if (!token)
            ...
            return res.status(response.$error === 401 ? response.$error : 403).send(response);
        }
        return next();
    }
}
